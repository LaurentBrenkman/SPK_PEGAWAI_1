...
<div class="card">
  <div class="card-body">
    ...
    // form opening
    echo form_open(base_url('admin/kriteria/edit_nilai/'.$kriteria->id_nilai_kriteria),' class="form-horizontal"');
    ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input type="text" name="nilai" class="form-control" placeholder="Nilai" value="<?php echo $kriteria->nilai ?>" required>
        </div>
    </div>
    <div class="form-group">
